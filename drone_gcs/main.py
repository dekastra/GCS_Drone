...
class MainFrame:
    def __init__(self,input_video_data, input_label):
        ...
        print(self.cam1, self.cam2, self.cam3, self.cam4)
        ...
        self.__fetcher1 = GetVideo(self.__data1, int(self.cam1))
        self.__fetcher2 = GetVideo(self.__data2, int(self.cam2))
        self.__fetcher3 = GetVideo(self.__data3, int(self.cam3))
        self.__fetcher4 = GetVideo(self.__data4, int(self.cam4))
        # self.__fetcher5 = GetVideo(self.__data5, self.cam5)

        # self.__fetcher1 = GetVideo(self.__data1, 4)
        # self.__fetcher2 = GetVideo(self.__data2, 0)
